...
export default function DeleteGameModalButton({ gameId, gameName }) {
	...
	const [errorMessage, setErrorMessage] = useState("Could not delete this game.");
	...
	return (
		<>
			...
			<Modal show={show} onHide={() => setShow(false)}>
				...
				<Modal.Body>
					<p className="mb-2">
						Are you sure you want to delete {gameName ? `\"${gameName}\"` : "this game"}?
					</p>
			...
			<ToastContainer position="top-end" className="p-3">
				<Toast
					...
					autohide
				>
					<Toast.Body className="text-white">Game deleted successfully.</Toast.Body>
				</Toast>
				<Toast
					bg="danger"
